...
【鑑定のルール】
- 単なる一般論ではなく、算命学の理論（陰占・陽占の組み合わせや構造）に基づいた具体的な根拠を説明してください。守護神・忌神については、**【命式内守護神・忌神】**として算出されているものを優先して採用し、鑑定に活かしてください。
...
合法・散法（位相法）、お互いの命式内守護神や命式内忌神、日干の結びつきなどを総合的に分析してください。
